...
var income : Double = 60000
var totalpayable : Double = 0
var incomeTaxRate : Double = 0
...
print("For a salary of $\(income), the income tax is $\(totalpayable)\n the effective income tax rate is \(incomeTaxRate)%")
